def loader_malha(gerenciador_modelo, gerenciador_camera, modelo, normal_Hxy, resolu): # carrega a malha
    ...
    if verificador != -1:
        gerenciador_modelo.projecao_malha(gerenciador_camera.get_Matrix_mudanca(), gerenciador_camera.camera_atual["C"], gerenciador_camera.camera_atual["d"], normal_Hxy, resolu)
    return verificador
